...
import headerImg from "../assets/img/Profile picture (1).png";
...
export const Banner = () => {
  ...
  const toRotate = ["Competitive Programmer", "Web Developer" ];
  const period = 2000;
  ...
  const checkResume = () => {
    window.open(' https://drive.google.com/file/d/1R9daaU4LW1gkdrEf5vfvrhLfC5NWWqAb/view?usp=drivesdk', '_blank');
  };
